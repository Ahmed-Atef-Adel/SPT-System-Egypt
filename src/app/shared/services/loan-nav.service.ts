...
export class LoanNavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		{
			headTitle: this.translate.instant('loan.Loans'),
		},
		{
			title: this.translate.instant('loan.credit'), icon: 'home', type: 'sub', children: [
				{ path: '', title: this.translate.instant('loan.Fund'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Control'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Cliets'), type: 'link' },
			]
		},
		{
			title: this.translate.instant('loan.Margin'), icon: 'database', type: 'sub', children: [
				{ path: 'loans/home', title: this.translate.instant('loan.Home'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Control'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Fund'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Categories'), type: 'link' },
				{ path: '', title: this.translate.instant('loan.Related_Accounts'), type: 'link' },
                { path: '', title: this.translate.instant('loan.Clients'), type: 'link' }
			]
		},
