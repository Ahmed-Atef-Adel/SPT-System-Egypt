...
import { checkHoriMenu, parentNavActive, switcherArrowFn } from '../sidebar/sidebar';
import { fromEvent } from 'rxjs';
import { BreakpointObserver, BreakpointState } from '@angular/cdk/layout';
import { Menu, LoanNavService } from '../../services/loan-nav.service';
@Component({
  selector: 'app-loan-sidebar',
  templateUrl: './loan-sidebar.component.html',
  styleUrls: ['./loan-sidebar.component.scss'],
...
export class LoanSidebarComponent {
  ...
  constructor(
    ...
    private navServices: LoanNavService,
